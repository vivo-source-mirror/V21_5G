...
#endif /* CONFIG_SND_SOC_CODEC_TAS2562 */
#ifdef CONFIG_SND_SOC_CODEC_TAS2562
	[MTK_SPK_TI_TAS2562] = {
...
#endif /* CONFIG_SND_SOC_CODEC_AW88263 */
};
			...
			const struct snd_soc_ops *i2s_ops)
{
	...
	spk_codec_name = vivo_get_codec_name();
	if (0 == strlen(spk_codec_name))

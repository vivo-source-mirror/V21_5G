...
extern void max20328_headset_device_plug_in(bool flag);
extern void max20328_switch_DPDM_connect(bool flag);
	...
	case TCP_NOTIFY_TYPEC_STATE:
		...
		if (noti->typec_state.old_state == TYPEC_UNATTACHED &&
			...
			if (max20328_is_ready) {
				...
				max20328_headset_device_plug_in(true);
				max20328_switch_DPDM_connect(true);
			}
			...
			if (max20328_is_ready) {
				...
				max20328_headset_device_plug_in(false);
			}

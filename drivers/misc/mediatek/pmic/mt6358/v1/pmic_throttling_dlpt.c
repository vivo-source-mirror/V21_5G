...
static struct meter_lib *mtr_lib = NULL;
#endif
 ...
 */
#ifdef CONFIG_VIVO_CHARGING_NEW_ARCH
#define bat_oc_h_thd(cur)	(65535-(cur*R_FG_VALUE*1000/UNIT_FGCURRENT*95*100/CAR_TUNE_VALUE))
#else
...
#ifdef CONFIG_VIVO_CHARGING_NEW_ARCH
	if (mtr_lib == NULL)
		mtr_lib = get_meter_lib();
	if (mtr_lib && mtr_lib->get_current)
		mtr_lib->get_current(mtr_lib, is_charging, &bat_cur);
#elif (CONFIG_MTK_GAUGE_VERSION == 30)

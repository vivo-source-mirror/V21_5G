...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_sync_active = 18; //14
	params->dsi.horizontal_backporch = 154;   //24
	params->dsi.horizontal_frontporch = 153;  //36
...
static void lcm_suspend_power(void)
{
	...
	lcm_enp_setting(0);
	MDELAY(5);
	LCM_INFO("[LCM]lcm_suspend_power ft8656- vddi keep high level\n");
	panel_reset_state = 0;
	LCM_INFO("\n");
}
...
struct LCM_DRIVER pd2066_ft8656_fhdplus_dsi_vdo_hx_lcm_drv = {
	.name = "pd2066_ft8656_fhdplus_dsi_vdo_hx",

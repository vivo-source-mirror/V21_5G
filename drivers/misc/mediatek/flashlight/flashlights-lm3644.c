...
#else
		if (device_id == 0x12) {
			pr_info("BBK_TORCH_LOW, LM3644_REG_TORCH_LEVEL_LED1 = 0x3F\n");
			lm3644_write_reg(lm3644_i2c_client, LM3644_REG_TORCH_LEVEL_LED1, 0x3F);/*(Brightness Code*2.91mA)+2.55mA Torch*/
		} else {
			lm3644_write_reg(lm3644_i2c_client, LM3644_REG_TORCH_LEVEL_LED1, 0x35);/*(Brightnees code x 1.4mA)+0.997ma Torch*/
		}
#endif

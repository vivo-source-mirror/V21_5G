...
#include "gc02m1bPD2103mipimono_Sensor.h"
#include "../imgsensor_i2c.h"
/****************************Modify Following Strings for Debug****************************/
#define PFX "GC02M1BPD2103_camera_sensor"
#define LOG_1 LOG_INF("GC02M1BPD2103,MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = GC02M1BPD2103_SENSOR_ID,
...
static kal_uint32 return_sensor_id(void)
{
	//return 0x02M1B;
	int tmp_id = 0x0;
	tmp_id = ((read_cmos_sensor(0xf0) << 8) | read_cmos_sensor(0xf1))+1;
	if (tmp_id == GC02M1BPD2103_SENSOR_ID) {
...
UINT32 GC02M1BPD2103_MIPI_MONO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{

...
#include "s5kgm1stPD2104mipiraw_freq.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGM1STPD2104_SENSOR_ID,
	...
	.normal_video = {
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 480000000,/*511200000*/
		.max_framerate = 300,
	},
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {  
	...
	{ 4000, 3000,	368,	276,   3264, 2448, 3264,  2448, 0000, 0000, 3264,  2448,	  0,	0, 3264,  2448}, /*custom1*/
...
extern int MAIN_F8D1_otp_read(void);
extern otp_error_code_t S5KGM1ST_OTP_ERROR_CODE;
MUINT32  sn_inf_main_s5kgm1st[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main_s5kgm1st[4];  
		...
		do {
			*sensor_id = read_cmos_sensor_16_16(0x0000) ;
			...
			if ( *sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = MAIN_F8D1_otp_read();
				pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,MAIN_F8D1_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, S5KGM1ST_OTP_ERROR_CODE);
				/*vivo lxd add end*/
				return ERROR_NONE;
			}
...
UINT32 S5KGM1STPD2104_MIPI_RAW_SensorInit(

...
#include "gc02m1PD2103mipimono_Sensor.h"
#include "../imgsensor_i2c.h"
/****************************Modify Following Strings for Debug****************************/
#define PFX "GC02M1PD2103_camera_sensor"
#define LOG_1 LOG_INF("GC02M1PD2103,MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	/*.sensor_id = GC02M1BPD2066A_SENSOR_ID, */
	.sensor_id = GC02M1PD2103_SENSOR_ID,
	...
	.i2c_addr_table = {0x20, 0x6e, 0xff},	//record sensor support all write id addr, only supprt 4must end with 0xff
};
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	...
	{1600, 1200, 160, 120, 1280,  960, 1280,  960, 0000, 0000, 1280,  960, 0, 0, 1280,  960},	/*custom1*/
	{1600, 1200, 0, 0, 1600, 1200, 1600, 1200, 0000, 0000, 1600, 1200, 0, 0, 1600, 1200},	/*custom5*/
};

extern int MICRGC02M_otp_read(void);
static int vivo_otp_read_when_power_on;
extern unsigned int is_atboot;
extern otp_error_code_t GC02M1PD2103_OTP_ERROR_CODE;
MUINT32  sn_inf_sub_gc02m1pd2103[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_gc02m1pd2103[4];  
extern int gc02m1pd2103_read_sn_id(void);
...
static kal_uint32 return_sensor_id(void)
{
	...
	if (tmp_id == GC02M1PD2103_SENSOR_ID) {
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if ((ANALOG_GAIN_1 <= iReg) && (iReg < ANALOG_GAIN_2)) {
		...
		LOG_INF
		    ("GC02M1BPD2066AMIPI analogic gain 1x, GC02M1BPD2066AMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066AMIPI analogic gain 1.185x, GC02M1BPD2066AMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066AMIPI analogic gain 1.4x, GC02M1BPD2066AMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066AMIPI analogic gain 1.659x, GC02M1BPD2066AMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066AMIPI analogic gain 2.0x, GC02M1BPD2066AMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066AMIPI analogic gain 2.37x, GC02M1BPD2066AMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066AMIPI analogic gain 2.8x, GC02M1BPD2066AMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066AMIPI analogic gain 3.318x, GC02M1BPD2066AMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066AMIPI analogic gain 4.0x, GC02M1BPD2066AMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066AMIPI analogic gain 4.74x, GC02M1BPD2066AMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066AMIPI analogic gain 5.6x, GC02M1BPD2066AMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066AMIPI analogic gain 6.636x, GC02M1BPD2066AMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066AMIPI analogic gain 8.0x, GC02M1BPD2066AMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066AMIPI analogic gain 9.48x, GC02M1BPD2066AMIPI add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, (temp & 0xff));
		LOG_INF
		    ("GC02M1BPD2066AMIPI analogic gain 11.2x, GC02M1BPD2066AMIPI add pregain = %d\n",
		     temp);
	}
	else {
		write_cmos_sensor(0xfe, 0x00);
...
static void custom1_setting(void)
{
	...
	write_cmos_sensor(0x90, 0x01);
	write_cmos_sensor(0x91, 0x00);
	write_cmos_sensor(0x92, 0x7e);
	write_cmos_sensor(0x93, 0x00);
	write_cmos_sensor(0x94, 0xa6);
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = MICRGC02M_otp_read();
				pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,MAIN_F8D1_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, GC02M1PD2103_OTP_ERROR_CODE);
				return ERROR_NONE;
			}
			LOG_INF
				  ...
				  UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
	    printk("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  GC02M1PD2103_OTP_ERROR_CODE:%d \n", *feature_data,GC02M1PD2103_OTP_ERROR_CODE);
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = GC02M1PD2103_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_sub_gc02m1pd2103, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_sub_gc02m1pd2103, sizeof(MUINT32)*4); 
			}
				break;
			}
			break;
...
UINT32 GC02M1PD2103_MIPI_MONO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*    GC02M1BPD2066A_MIPI_RAW_SensorInit    */

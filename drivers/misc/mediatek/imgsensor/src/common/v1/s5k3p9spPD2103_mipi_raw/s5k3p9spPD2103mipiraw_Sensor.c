...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K3P9SPPD2103_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {  
	...
	{ 4640, 3488,	  0,	0, 4640, 3488, 4640,  3488, 0000, 0000, 4640,  3488,	  0,	0, 4640, 3488}, /*custom5*/
};
...
MUINT32  sn_inf_sub_s5k3p9sp04[13];  /*0 flag   1-12 data*/
MUINT32 crosstalk_data[2049];  /*0 flag   1-836 data*/
MUINT32  material_inf_sub_s5k3p9sp04[4];  
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	PK_DBG("S5K3P9SPmipiraw_Sensor I2C_BUS = %d\n", I2C_BUS);	
	if(I2C_BUS != 2){	
			...
			*sensor_id = ((read_cmos_sensor_16_8(0x0000) << 8) | read_cmos_sensor_16_8(0x0001));
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
			 ...
			 /*vivo hope add for AT cammand start*/
				...
				PK_DBG("cfx_add:end read eeprom ---vivo_otp_read_when_power_on = %d,S5K3P9SP04_OTP_ERROR_CODE =%d\n", vivo_otp_read_when_power_on, S5K3P9SP04_OTP_ERROR_CODE);
				/*vivo hope  add end*/
				return ERROR_NONE;
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE: 	/*ITS test_sensor_fusion */
  		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 100;
  		break;
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5K3P9SP04_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_sub_s5k3p9sp04, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_sub_s5k3p9sp04, sizeof(MUINT32)*4); 
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_sub_s5k3p9sp04[%d]= 0x%x\n", i, sn_inf_sub_s5k3p9sp04[i]);
						}
				#endif
			}
				break;
...
UINT32 S5K3P9SPPD2103_MIPI_RAW_SensorInit(

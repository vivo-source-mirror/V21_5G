 ...
 * Filename:
 * ---------
 *	 s5kgh1sm24pd2083mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGH1SM24PD2083F_EX_SENSOR_ID,
...
//	{ 7968, 5480,	144,	580,	7680, 4320, 1920, 1080,	0000, 0000,	1920,  1080,	  0,	0, 	1920,  1080}, /*slim video  hs_video 240fps*/
	...
	{ 7968, 5480,	144,	580,	7680, 4320, 1280, 720,	0000, 0000,	1280,  720,	  0,	0, 	1280,  720}, /*slim video  hs_video 240fps*/
...
static kal_uint16 addr_data_pair_init[] = {
	...
	0x6F12, 0x0300,
	0x0A70, 0x0001,
	0x0A72, 0x0100,  //GPIO Enable as vsync	
};
...
#ifdef HOPE_ADD_FOR_CAM_TEMPERATURE_NODE  //add for s5kgh1sm24 temperature 
static kal_uint32 get_sensor_temperature(void)
{
	
	static DEFINE_RATELIMIT_STATE(ratelimit, 2 * HZ, 1);
	INT32	TMC_000A_Value=0,TMC_Value =0;/*TMC_Shift_Value=0*/; 
	
	write_cmos_sensor_16_16(0x6028, 0x4000);
	TMC_000A_Value=read_cmos_sensor_16_16(0x0020);
	//TMC_Shift_Value =((TMC_000A_Value&0x00FF)<<8)|((TMC_000A_Value&0xFF00)>>8);
	
	PK_DBG("S5KGH1SM24 TMC 0X000A Value=0x%4x\n", TMC_000A_Value);

	if (TMC_000A_Value > 0x7FFF && TMC_000A_Value <= 0xFFFF){
		//TMC_Value=0-(((((~TMC_000A_Value)&0xFFFF) +1)>>8)&0xFF);
		if (__ratelimit(&ratelimit))
	  		PK_DBG("S5KGH1SM24 TMC Value=%d is < 0 ,TMC is Disable TMC_000A_Value =0x%x\n", 0-(((((~TMC_000A_Value)&0xFFFF) +1)>>8)&0xFF),TMC_000A_Value);
	}
	else{
		TMC_Value=(TMC_000A_Value>>8)&0xFF;
		if (TMC_Value > 128){
			PK_DBG("S5KGH1SM24 TMC 0X000A temperature Value=%d, cause of TMC > 128 \n", TMC_Value);
			TMC_Value = 0;
		}
		sensor_temperature[1] = TMC_Value;
		if (__ratelimit(&ratelimit))
			PK_DBG("S5KGH1SM24 TMC 0X000A temperature Value=0x%x, sensor_temperature[0] =%d\n", TMC_Value, sensor_temperature[1]);
	}
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
...
#ifdef HOPE_ADD_FOR_CAM_TEMPERATURE_NODE //add for s5kgw3sp13 temperature 	
	INT32 *feature_return_para_i32 = (INT32 *) feature_para;
#endif
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 3530000;
		break;
...
UINT32 S5KGH1SM24PD2083F_EX_MIPI_RAW_SensorInit(
